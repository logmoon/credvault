...
export function ClipboardToast({ type, timeoutSecs }: ClipboardToastProps) {
  return (
    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-surface-overlay border border-border-subtle rounded-lg px-4 py-2.5 shadow-sm transition-opacity">
